...
<div class="relative bg-gray-50 overflow-hidden">
    ...
    <section data-section-id="7" data-category="ma-se-blog" data-component-id="20e5a82b_02_awz" data-custom-component-id="106217">
        <div class="skew skew-top mr-for-radius">
            <svg class="h-8 md:h-12 lg:h-20 w-full text-gray-50" viewBox="0 0 10 10" preserveAspectRatio="none"><polygon fill="currentColor" points="0 0 10 10 0 10"></polygon></svg>
        </div>
        <div class="skew skew-top ml-for-radius">
            <svg class="h-8 md:h-12 lg:h-20 w-full text-gray-50" viewBox="0 0 10 10" preserveAspectRatio="none"><polygon fill="currentColor" points="0 10 10 0 10 10"></polygon></svg>
        </div>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="relative flex flex-wrap -mx-4 z-0">
                    ...
                    <div class="w-full lg:w-1/3 px-4 text-center">
                        ...
                        <p class="text-gray-500 leading-loose">When new players join Neftify using your loaned Axies, you get 25% of their earnings.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="skew skew-bottom mr-for-radius">
            <svg class="h-8 md:h-12 lg:h-20 w-full text-gray-50" viewBox="0 0 10 10" preserveAspectRatio="none"><polygon fill="currentColor" points="0 0 10 0 0 10"></polygon></svg>
        </div>
        <div class="skew skew-bottom ml-for-radius">
            <svg class="h-8 md:h-12 lg:h-20 w-full text-gray-50" viewBox="0 0 10 10" preserveAspectRatio="none"><polygon fill="currentColor" points="0 0 10 0 10 10"></polygon></svg>
        </div>
    </section>
                ...
                <div class="flex flex-wrap items-center">
                    <div class="w-full lg:w-1/2 mb-12 lg:mb-0">
                        <div class="max-w-md lg:mx-auto">
                            ...
                            <p class="mb-6 text-gray-500 leading-loose">When you lend your Axies to Neftify, you’ll earn 25% of the SLP generated by players who use them.</p>
                    ...
                    <div class="w-full lg:w-1/2 flex flex-wrap -mx-4">
                        <div class="mb-8 lg:mb-0 w-full md:w-1/2 px-4">
                            ...
                            <div class="py-6 pl-6 pr-4 shadow rounded bg-white">
                                ...
                                <p class="text-gray-500 leading-loose">Receive 25% of a player's earnings for as long as your Axies are deposited.</p>
                            </div>
                        </div>
