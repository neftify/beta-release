...
?>
          ...
          <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="grid grid-cols-2 gap-8 xl:col-span-2">
              <div class="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul class="mt-4"><li><a class="text-base leading-6 text-gray-300 hover:text-white" href="/about">About</a></li>
                ...
                <div class="mt-12 md:mt-0">
                  ...
                  <ul class="mt-4"><li><a class="text-base leading-6 text-gray-300 hover:text-white" href="https://medium.com/neftify" target="_blank">Medium</a></li>
            ...
            <div class="mt-8 xl:mt-0">
              ...
              <form id="chimp-form" class="mt-4 sm:flex sm:max-w-md" action="/front-end/mailchimp/subscribe.php" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" novalidate>
                <input id="chimp-email" class="appearance-none w-full px-5 py-3 border border-transparent text-base leading-6 rounded-md text-gray-900 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 transition duration-150 ease-in-out" aria-label="Email address" type="email" required="" placeholder="Enter your email"><div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button class="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-400 focus:outline-none focus:bg-indigo-400 transition duration-150 ease-in-out" type="submit">Subscribe</button>
                </div>
              </form>
    ...
    <script src="/front-end/js/web3-app.js"></script>
