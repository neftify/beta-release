...
<div class="relative bg-gray-50 overflow-hidden">
    ...
    <div class="relative pt-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
        ...
        <main class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28" id="app">
            <div class="text-center">
                ...
                <div v-show="state == 'needLogInToMetaMask' || state == 'signTheMessage'" class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
