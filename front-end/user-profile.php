                ...
                <div class="py-4">
                    <div class="bg-white shadow sm:rounded-lg">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Payout Address For Axie Infinity</h3>
                            <div class="mt-5">
                                <div class="rounded-md bg-gray-50 px-6 py-5 sm:flex sm:items-start sm:justify-between">
                                    <div class="sm:flex sm:items-start">
                                        <div class="mt-3 sm:mt-0 sm:ml-4">
                                            <div class="text-sm leading-5 font-medium text-gray-900"><?php echo hide_address_ronin($lender_ronin_address); ?></div>
                                            <div class="mt-1 text-sm leading-5 text-gray-600 sm:flex sm:items-center">
                                                ...
                                                <div class="mt-1 sm:mt-0">
                                                    This address was generated using the Ethereum wallet that you connected to Neftify. Make sure that your Ronin wallet matches this address. By design, Ronin’s bridge replaces the ‘0x’ of
                                                    your Ethereum wallet for ‘ronin:’ When you deposit Axies to one of our pools, we map it to that address. You will need to log in to the Ronin network with your Metamask
                                                    <b><?php echo hide_address_0x($lender_eth_address); ?></b> address to withdraw your earnings.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
