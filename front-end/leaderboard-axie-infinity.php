<?php
    ...
    $oDate = new DateTime('@' . $input, new DateTimeZone('America/Puerto_Rico'));

    $oDate = $oDate->format('Y-m-d h:i:s A');
...
<div class="relative py-16 bg-white overflow-hidden">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="text-lg max-w-prose mx-auto mb-6">
            ...
            Neftify's Leaderboard represents the top 10 best players in the club for the month. Being a top 10 player earns you special perks, additional rewards, and private access to the Leaderboard Lounge. Furthermore, Leaderboard players are reserved Neftify's best Axies for participating in intramural and inter-community eSports competitions.
            </p>
        </div>
...
<div class="relative py-16 bg-white overflow-hidden">
    <div class="relative px-4 sm:px-6 lg:px-8">
        <ul class="mt-3 grid grid-cols-1 gap-5 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <li class="col-span-1 flex items-center bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden">
                <div class="flex-shrink-0 flex items-center justify-center w-16 h-16 text-white text-center text-sm leading-5 font-medium bg-orange-500" style="background: #4d46dd !important;">TIER 3</div>
                <div class="flex-1 px-4 py-2 truncate">
...
<div class="relative py-16 bg-white overflow-hidden">
  ...
  <ul>
    ...
    ?>
    <li>
      <a class="block hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out" href="#">
            ...
            <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
              <div>
                ...
                <div class="mt-2 flex items-center text-sm leading-5 text-gray-500">
                  <span class="truncate">Scholar #<?php echo $player['id']; ?></span>
                </div>
              </div>
              <div class="hidden md:block">
                <div>
                  <div class="text-sm leading-5 text-gray-900">SLP Generated In The Last 24 Hours</div>
                  <div class="mt-2 flex items-center text-sm leading-5 text-gray-500">
                    ...
                    <span><?php echo $player['slp_last_24_hours']; ?></span>
                  </div>
                </div>
              </div>
            </div>
    ...
    <p style="margin: 10px;font-size: 10px;">*Last update at <?php echo $oDate; ?> AST.</p>
    </div>
</div>
