        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <dl>
                    ...
                    <dd class="mt-1 text-3xl leading-9 font-semibold text-gray-900"><?php echo get_current_axie_borrowers_with_commas(); ?></dd>
                </dl>
            </div>
        </div>
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <dl>
                    ...
                    <dd class="mt-1 text-3xl leading-9 font-semibold text-gray-900"><?php echo get_current_axie_lender_apy(); ?>%</dd>
                </dl>
            </div>
        </div>
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <dl>
                    ...
                    <dd class="mt-1 text-3xl leading-9 font-semibold text-gray-900">$<?php echo get_current_axie_tvl_with_commas(); ?></dd>
                </dl>
            </div>
        </div>
    </div>
