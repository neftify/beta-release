      ...
      <div class="relative py-16 bg-white overflow-hidden">
        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
          <div class="text-lg max-w-prose mx-auto mb-6">
            ...
            <p class="text-xl text-gray-500 leading-8">Neftify Labs is a technology company focused on building open-source products and services for the future of the metaverse. We do this by connecting creators, lenders, and players to generate new ways for people to earn and live. We are starting with Neftify, a platform that facilitates revenue share between blockchain game players and lenders. Still, we see this as just the beginning of the future of making money on the metaverse. We hope to inspire new metonomic models beyond video games, which we believe will be the do-to-earn economy.</p>
          </div>
