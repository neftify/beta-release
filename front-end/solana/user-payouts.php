                    ...
                    <div class="bg-gray-50 pt-12 sm:pt-16">
                        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="max-w-4xl mx-auto text-center">
                                <h2 class="text-3xl leading-9 font-extrabold text-gray-900 sm:text-4xl sm:leading-10">Helium</h2>
                                <p class="mt-3 text-xl leading-7 text-gray-500 sm:mt-4">Payouts are made automatically within 72h to your saved Helium wallet.</p>
                            </div>
                        </div>
