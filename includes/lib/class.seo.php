<?php
    ...
    function social_tags($array) {
        //General Tags
        echo '<meta name="twitter:site" content="'.get_setting(8).'">'."\n";
        echo '<meta property="og:site_name" content="'.get_setting(8).'" />'."\n";
        ...
        if(!empty($array['image'])) {
            ...
            echo '<meta name="twitter:image" content="'.get_domain().'/front-end/images/social-media-picture.png">'."\n";
            echo '<meta property="og:image" content="'.get_domain().'/front-end/images/social-media-picture.png" />'."\n";
        }
